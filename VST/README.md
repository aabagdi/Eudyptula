...
## What it sounds like
It sounds a bit like a bitcrusher, but with a bit more sounds you can get out of it. As well, the quality of the distortion can almost sound like something out of an NES, or a crazy noisy assault. Perfect for the Merzbow in us all. Sound samples coming soon!

## Building
JUCE is not included in this repo, so you'll need your own copy. Eudyptula is built with JUCE 9.0.1, so I’m not sure if earlier JUCE versions will work.

1. Clone [JUCE](https://github.com/juce-framework/JUCE) and build the Projucer.
2. Set **File → Global Paths → JUCE modules** to your `JUCE/modules` directory.
